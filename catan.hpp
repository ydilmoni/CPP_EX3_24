...
//     {
//     public:
//         vector<reference_wrapper<Player>> players; // List of players in the game
//         Board board;                               // Game board
//         map<string, Deck> decks;                   // Decks of development cards

//         map<pair<int, int>, Player *> gameEdges; // Edges on the game board and their owner
//         vector<pair<Player *, string>> gameNode; // Nodes on the game board and their building type
...
//         /**
//          * @brief Starts the initial placement phase of the game.
//          */
//         void startGame();
...
//          */
//         void setGameNode(int nodeIndex, Player &player, string buildingType);
...
//          */
//         vector<int> getUnoccupiedNodeVector();
...
//          */
//         vector<pair<int, int>> getPlacesForRoadByPlayerIndex(int playerIndex);
...
//          */
//         string ms(int amount, int firstStart, int firstEnd);
